...
import { handleMobileMenuFilters } from '../../../entities/componentsSlice';
...
import styles from './ListFlatsFilterModalMobile.module.scss';

const ListFlatsFilterModalMobile = () => {
    ...
    return (
        <div className={styles.listRight}>
            <div
                onClick={() => {
                    dispatch(handleMobileMenuFilters(false));
                }}
            ...
            <div className={styles.listRight__filters}>
                ...
                <div className={styles.listRight__modal}>
                    ...
                    {isModal && (
                        <ModalSort handleClose={handleCloseModal} params={filterParameters.byCheckbox.sections} id={'switch-sections'} />
                    )}
                </div>
                <RangeSlider
                    key={isKey.inputArea}
...
export default ListFlatsFilterModalMobile;
